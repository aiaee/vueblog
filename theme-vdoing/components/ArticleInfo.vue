      ...
      >
        ...
        <li>
          <router-link
            ...
            :title="articleInfo.classify1+'-catalog'"
...
export default {
  ...
  methods: {
    getPageInfo () {
      ...
      const cataloguePermalink = sidebar && sidebar.catalogue ? sidebar.catalogue[classify1] : undefined// catalog永久链接

      const author = this.$frontmatter.author || this.$themeConfig.author // Author
      let date = (pageInfo.frontmatter.date || '').split(' ')[0] // 文章Date
